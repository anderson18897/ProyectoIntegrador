...
public class Ventana extends javax.swing.JFrame {
    ...
    static ArrayList<Double> datos1 = new ArrayList<>();//Aca Volvemos nuestra lista de strings en numericos
    static ArrayList<Double> datos2 = new ArrayList<>();
    ...
    static ArrayList<Double> fr = new ArrayList<>(); //Frecuencias Relativas
    static ArrayList<Double> Fr = new ArrayList<>(); //Frecuencias Relativa Acumulada
    static ArrayList<Double> XifiAdd = new ArrayList<>(); //Multiplicacion agregada a la tabla
    static ArrayList<Double> absd = new ArrayList<>(); //Agregamos los valores absolutos de cada frecuencia de |d|
    static ArrayList<Double> fd = new ArrayList<>();//la multiplicacion de la frecuencia con la desviacion estandar
    static ArrayList<Double> delevado = new ArrayList<>();//para el calculo de la varianza
    static ArrayList<Double> d = new ArrayList<>();//Desviacion Media
    static ArrayList<Double> fdelevado = new ArrayList<>();//para el calculo de la varianza frecuencias por desviaciones elevadas al cuadrado
    static ArrayList<Integer> RangoSemiQ1 = new ArrayList<>();
    static ArrayList<Integer> RangoSemiQ2 = new ArrayList<>();
    static ArrayList<Integer> RangoP10 = new ArrayList<>();
    static ArrayList<Integer> RangoP90 = new ArrayList<>();
    static ArrayList<Double> Xifi = new ArrayList<>(); //Multiplicacion para la MA
    static ArrayList<Double> lista2 = new ArrayList<>(); //nos servira para pasar de objeto de lista a lista2
    static ArrayList<Double> Mediana = new ArrayList<>(); //NOs sirve para calculos de la mediana
    static ArrayList<Double> Moda = new ArrayList<>();
    static ArrayList<Double> listapmg = new ArrayList<>();//lista para potencias de media cuadratica
    static ArrayList<Integer> Qdatos = new ArrayList<>();//lista para agregar los candidatos de cuartil
    static ArrayList<Integer> Qdatos1 = new ArrayList<>();//lista para agregar los candidatos del percentil 1 rango
    static ArrayList<Integer> Qdatos2 = new ArrayList<>();//lista para agregar los candidatos del Percentil 2 Rango
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(String.valueOf(getClass().getClassLoader().getResourceAsStream("src/main/java/Imagenes/escobita.png")))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(String.valueOf(getClass().getClassLoader().getResourceAsStream("src/main/java/Imagenes/chek.png")))); // NOI18N
        ...
        jLabel27.setIcon(new javax.swing.ImageIcon(String.valueOf(getClass().getClassLoader().getResourceAsStream("src/main/java/Imagenes/logo_estadistica.png")))); // NOI18N

        btnH.setIcon(new javax.swing.ImageIcon(String.valueOf(getClass().getClassLoader().getResourceAsStream("src/main/java/Imagenes/estadistica.png")))); // NOI18N
        btnH.setText("Graficar Histograma");
        btnH.addActionListener(this::btnHActionPerformed);

        jButton5.setIcon(new javax.swing.ImageIcon(String.valueOf(getClass().getClassLoader().getResourceAsStream("src/main/java/Imagenes/escobita.png")))); // NOI18N
        ...
        jLabel2.setFont(new java.awt.Font("Tahoma", Font.BOLD | Font.ITALIC, 14)); // NOI18N
        ...
        btnMA.addActionListener(this::btnMAActionPerformed);
        ...
        jTextField52.setFont(new java.awt.Font("Tahoma", Font.BOLD | Font.ITALIC, 11)); // NOI18N
        ...
        jTextField53.setFont(new java.awt.Font("Tahoma", Font.BOLD | Font.ITALIC, 11)); // NOI18N
        ...
        jLabel17.setFont(new java.awt.Font("Tahoma", Font.BOLD, 11)); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(String.valueOf(getClass().getClassLoader().getResourceAsStream("src/main/java/Imagenes/about.png")))); // NOI18N
        ...
        if (evt.getSource() == ComboBox1) {
            ...
            if ("Cuartil".equals(seleccionado)) {//calculo de los cuartiles
                ...
                if (f.isEmpty()) {
                    ...
                    try {
                        Qk = Integer.parseInt(jTextField51.getText());
                    ...
                    if (Qk < 1 | Qk > 3) {
                        ...
                        Qp = (double) (Qk * datos.size()) / 4;

                        for (int i = 0; i < F.size(); i++) {
                            if (Double.parseDouble(F.get(i)) >= Qp) {
                                Qdatos.add(F.indexOf(F.get(i)));
                            }
                        }
                        double Cuartil = Double.parseDouble(lista1.get(Qdatos.get(0)));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (f.isEmpty()) {
            ...
            double Count4 = 0;
            for (Double aDouble : fd) {
                Count4 = Count4 + aDouble;
            }
            ...
            double Count8 = 0;
            for (Double aDouble : fdelevado) {
                Count8 = Count8 + aDouble;
            }
            ...
            jLabelCoeficienteVariacion.setText("= " + String.format("%.2f", vp) + " รณ " + String.format("%.2f", (vp * 100)) + "%");
            ...
            double RQp1 = (double) (datos.size()) / 4;
            for (int i = 0; i < F.size(); i++) {
                if (Double.parseDouble(F.get(i)) >= RQp1) {
                    RangoSemiQ1.add(F.indexOf(F.get(i)));
                }
            }
            double Cuartil1 = Double.parseDouble(lista1.get(RangoSemiQ1.get(0)));
            double RQp2 = (double) (3 * datos.size()) / 4;
            for (int i = 0; i < F.size(); i++) {
                if (Double.parseDouble(F.get(i)) >= RQp2) {
                    RangoSemiQ2.add(F.indexOf(F.get(i)));
                }
            }
            double Cuartil3 = Double.parseDouble(lista1.get(RangoSemiQ2.get(0)));
            double RangoSemi = Cuartil3 - Cuartil1;

            double Pp1 = (double) (10 * datos.size()) / 100;
            for (int i = 0; i < F.size(); i++) {
                if (Double.parseDouble(F.get(i)) >= Pp1) {
                    RangoP10.add(F.indexOf(F.get(i)));
                }
            }
            double Percentil10 = Double.parseDouble(lista1.get(RangoP10.get(0)));
            double Pp2 = (double) (90 * datos.size()) / 100;
            for (int i = 0; i < F.size(); i++) {
                if (Double.parseDouble(F.get(i)) >= Pp2) {
                    RangoP90.add(F.indexOf(F.get(i)));
                }
            }
            double Percentil90 = Double.parseDouble(lista1.get(RangoP90.get(0)));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (f.isEmpty()) {
            ...
            try {
                Rp1 = Integer.parseInt(jTextField52.getText());
                Rp2 = Integer.parseInt(jTextField53.getText());
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(null, "Solicitud Incorrecta \nDigite un Numero Valido");
            }
            if (Rp1 < 1 | Rp1 > 99 | Rp2 < 1 | Rp2 > 99) {
                ...
                if (Rp1 > Rp2) {
                    ...
                    Qp1 = (double) (Rp1 * datos.size()) / 100;

                    for (int i = 0; i < F.size(); i++) {
                        if (Double.parseDouble(F.get(i)) >= Qp1) {
                            Qdatos1.add(F.indexOf(F.get(i)));
                        }
                    }
                    double Percentil1 = Double.parseDouble(lista1.get(Qdatos1.get(0)));

                    Qp2 = (double) (Rp2 * datos.size()) / 100;
                    for (int i = 0; i < F.size(); i++) {
                        if (Double.parseDouble(F.get(i)) >= Qp2) {
                            Qdatos2.add(F.indexOf(F.get(i)));
                        }
                    }
                    double Percentil2 = Double.parseDouble(lista1.get(Qdatos2.get(0)));
    ...
    private void btnMAActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (f.isEmpty()) {
            ...
            for (int i = 0; i < lista1.size(); i++) {
                double j = Double.parseDouble(lista1.get(i)) * f.get(i);//este recorrifo realiza la multiplicacion de las frecuencias con X
            ...
            if (m == 0) {
                ...
                for (int i = 0; i < F.size(); i++) {//aca mediante un rrecorrido buscamos donde se encuentra la pocicion de la mediana
                    if (Integer.parseInt(F.get(i)) >= Me) {
            ...
            jTextArea1.append("\nLa Moda es " + lista1.get(f.indexOf(Collections.max(f))));
            Modax = Double.parseDouble(lista1.get(f.indexOf(Collections.max(f))));

            double moda = Collections.max(f);
            for (Integer integer : f) {
                if (moda == integer) {
                    Moda.add(Double.valueOf(integer));//con este recorrido evaluamos si existen mas valores dentro de la frecuencia que se repitan
            ...
            //----------------------------------------------------------------------------------------------------Media Geometrica
            for (int i = 0; i < lista1.size(); i++) {
                double pp = Math.pow(Double.parseDouble(lista1.get(i)), Double.valueOf(f.get(i)));
                listapmg.add(pp);
            }

            double mullistapmg = 1;
            for (Double aDouble : listapmg) {
                mullistapmg = aDouble * mullistapmg;
            }
            ...
            double summc = 0;
            for (int i = 0; i < lista1.size(); i++) {
                double var2 = Math.pow(Double.parseDouble(lista1.get(i)), 2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (jTextField10.getText().isEmpty()) {//aca llevamos los 10JtextsFielsd Xd
        } else {
        ...
        if (jTextField50.getText().isEmpty()) {
        } else {
        ...
        for (String dato : datos) {
            try {
                datos1.add(Double.parseDouble(dato));
            } catch (NumberFormatException ex) {
                c.add(dato);
            }
        }
        ...
        if (c.isEmpty()) {
            for (Double aDouble : datos1) {
                if (datos2.contains(aDouble)) {
                } else {
                    datos2.add(aDouble);
                }
            }
            ...
            for (Object o : lista) {
                f.add(Collections.frequency(datos1, o));
            }
            ...
            double l = 0;
            for (Double aDouble : fr) {//codigo completamente funcional
                double k = aDouble + l;
                Fr.add(k);
                l = l + aDouble;
            }//-------------------------------------Fin Bloque Anterior
            ...
            for (int i = 0; i < f.size(); i++) {//codigo completamente funcional
                double k = Double.parseDouble(lista1.get(i)) * f.get(i);
                XifiAdd.add(k);
            }
            //-------------------------------------------Fin Addxifi
            ...
            double Count1 = 0;
            for (Double aDouble : XifiAdd) {//codigo completamente funcional
                Count1 = Count1 + aDouble;
            }
            ...
            //----------------------------------------------------------------------Desviacion
            double Count6;
            for (String s : lista1) {//codigo completamente funcional
                Count6 = Double.parseDouble(s) - MediaAritmetica;
                d.add(Count6);
            }
            ...
            double Count2;
            for (String s : lista1) {//codigo completamente funcional
                Count2 = Math.abs(Double.parseDouble(s) - MediaAritmetica);
                absd.add(Count2);
            }
            //-----------------------------------------------------------Fin
            ...
            double Count5 = 0;
            for (String s : lista1) {
                Count5 = Math.pow(Double.parseDouble(s) - MediaAritmetica, 2);
                delevado.add(Count5);
            ...
            //------------------------------------------aca insertamos los valores a la tabla de frecuncias
            for (int i = 0; i < lista.size(); i++) {
        ...
        jTextArea1.append("\nDatos Convertidos:  ");
        for (Double aDouble : datos1) {
            jTextArea1.append(aDouble + "  ");
        }
        jTextArea1.append("\nDatos No reptidos:  ");
        for (Double aDouble : datos2) {
            jTextArea1.append(aDouble + "  ");
        }
